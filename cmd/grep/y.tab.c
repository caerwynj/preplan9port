...
#line	2	"/home/xcs0998/src/cmd/grep/grep.y"
#include	"grep.h"

#line	5	"/home/xcs0998/src/cmd/grep/grep.y"
typedef union 
{
	int	val;
	char*	str;
...
#line	115	"/home/xcs0998/src/cmd/grep/grep.y"
...
case 1:
#line	22	"/home/xcs0998/src/cmd/grep/grep.y"
{
...
case 3:
#line	34	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re = re2or(yypt[-2].yyv.re, yypt[-0].yyv.re);
	} break;
case 5:
#line	40	"/home/xcs0998/src/cmd/grep/grep.y"
{ literal = 1; } break;
case 6:
#line	41	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re = yypt[-0].yyv.re;
	} break;
case 8:
#line	48	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re = re2or(yypt[-2].yyv.re, yypt[-0].yyv.re);
	} break;
case 10:
#line	55	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re = re2cat(yypt[-1].yyv.re, yypt[-0].yyv.re);
	} break;
case 12:
#line	62	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re = re2star(yypt[-1].yyv.re);
	} break;
case 13:
#line	66	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re.beg = ral(Talt);
		patchnext(yypt[-1].yyv.re.end, yyval.re.beg);
		yyval.re.beg->_u.alt = yypt[-1].yyv.re.beg;
		yyval.re.end = yyval.re.beg;
		yyval.re.beg = yypt[-1].yyv.re.beg;
	} break;
case 14:
#line	74	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re.beg = ral(Talt);
		yyval.re.beg->_u.alt = yypt[-1].yyv.re.beg;
...
case 15:
#line	83	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re.beg = ral(Tclass);
		yyval.re.beg->_u._c.lo = yypt[-0].yyv.val;
		yyval.re.beg->_u._c.hi = yypt[-0].yyv.val;
		yyval.re.end = yyval.re.beg;
	} break;
case 16:
#line	90	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re.beg = ral(Tbegin);
		yyval.re.end = yyval.re.beg;
	} break;
case 17:
#line	95	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re.beg = ral(Tend);
		yyval.re.end = yyval.re.beg;
	} break;
case 18:
#line	100	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re = re2class("^\n");
	} break;
case 19:
#line	104	"/home/xcs0998/src/cmd/grep/grep.y"
{
		yyval.re = re2class(yypt[-0].yyv.str);
	} break;
case 20:
#line	108	"/home/xcs0998/src/cmd/grep/grep.y"
{
