...
#line	11	"/home/xcs0998/src/cmd/lex/parser.y"
# include "ldefs.h"
...
#line	21	"/home/xcs0998/src/cmd/lex/parser.y"
int i;
int j,k;
int g;
uchar *p;
...
#line	217	"/home/xcs0998/src/cmd/lex/parser.y"
...
case 1:
#line	27	"/home/xcs0998/src/cmd/lex/parser.y"
{	
# ifdef DEBUG
		if(debug) sect2dump();
# endif
...
case 3:
#line	35	"/home/xcs0998/src/cmd/lex/parser.y"
{
		if(!funcflag)phead2();
		funcflag = TRUE;
	} break;
case 4:
#line	40	"/home/xcs0998/src/cmd/lex/parser.y"
{
# ifdef DEBUG
		if(debug) {
			sect1dump();
...
case 7:
#line	51	"/home/xcs0998/src/cmd/lex/parser.y"
...
case 9:
#line	66	"/home/xcs0998/src/cmd/lex/parser.y"
{
# ifdef DEBUG
...
case 10:
#line	74	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn2(RNEWE,yypt[-1].yyv.i,yypt[-0].yyv.i);
		} break;
case 11:
#line	77	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = yypt[-0].yyv.i;} break;
case 12:
#line	80	"/home/xcs0998/src/cmd/lex/parser.y"
{
		if(divflg == TRUE)
...
case 13:
#line	89	"/home/xcs0998/src/cmd/lex/parser.y"
{
# ifdef DEBUG
		if(debug) sect2dump();
# endif
...
case 14:
#line	95	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn0(yypt[-0].yyv.i); } break;
case 15:
#line	97	"/home/xcs0998/src/cmd/lex/parser.y"
{
		p = yypt[-0].yyv.cp;
		i = mn0(*p++);
		while(*p)
...
case 16:
#line	105	"/home/xcs0998/src/cmd/lex/parser.y"
{	symbol['\n'] = 0;
		if(psave == FALSE){
			p = ccptr;
			psave = ccptr;
			...
			*ccptr++ = 0;
			...
			p = psave;
		yyval.i = mn1(RCCL,(int)p);
		cclinter(1);
		} break;
case 17:
#line	127	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn1(RCCL,yypt[-0].yyv.i); } break;
case 18:
#line	129	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn1(RNCCL,yypt[-0].yyv.i); } break;
case 19:
#line	131	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn1(STAR,yypt[-1].yyv.i); } break;
case 20:
#line	133	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn1(PLUS,yypt[-1].yyv.i); } break;
case 21:
#line	135	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn1(QUEST,yypt[-1].yyv.i); } break;
case 22:
#line	137	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn2(BAR,yypt[-2].yyv.i,yypt[-0].yyv.i); } break;
case 23:
#line	139	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn2(RCAT,yypt[-1].yyv.i,yypt[-0].yyv.i); } break;
case 24:
#line	141	"/home/xcs0998/src/cmd/lex/parser.y"
{	if(!divflg){
...
case 25:
#line	153	"/home/xcs0998/src/cmd/lex/parser.y"
...
case 26:
#line	174	"/home/xcs0998/src/cmd/lex/parser.y"
{
...
case 27:
#line	185	"/home/xcs0998/src/cmd/lex/parser.y"
{
				/* from n to infinity */
...
case 28:
#line	199	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn2(RSCON,yypt[-0].yyv.i,yypt[-1].yyv.i); } break;
case 29:
#line	201	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = mn1(CARAT,yypt[-0].yyv.i); } break;
case 30:
#line	203	"/home/xcs0998/src/cmd/lex/parser.y"
{	i = mn0('\n');
		if(!divflg){
			j = mn1(S2FINAL,-casecount);
...
case 31:
#line	213	"/home/xcs0998/src/cmd/lex/parser.y"
{	yyval.i = yypt[-1].yyv.i; } break;
case 32:
#line	215	"/home/xcs0998/src/cmd/lex/parser.y"
